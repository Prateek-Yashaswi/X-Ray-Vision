        ...
        <ReactBootStrap.Navbar bg="dark" expand="lg" sticky="top">
            ...
            <ReactBootStrap.Navbar.Collapse id="basic-navbar-nav">
                <ReactBootStrap.Nav className="ml-auto link-div">
                    ...
                    <NavLink exact to='/technologies' className='nav-link'><span className="nav-link-text">Technologies</span></NavLink>
                    <NavLink exact to='/discussion' className='nav-link'><span className="nav-link-text">Forum</span></NavLink>
                </ReactBootStrap.Nav>
