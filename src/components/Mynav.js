    ...
    return (
        <ReactBootStrap.Navbar bg="dark" expand="lg" sticky="top">
            ...
            <ReactBootStrap.Navbar.Collapse id="basic-navbar-nav">
                <ReactBootStrap.Nav className="mr-auto link-div">
                    <NavLink exact to='/' className='nav-link'><span className="nav-link-text">Home</span></NavLink>
                    <NavLink exact to='/content' className='nav-link'><span className="nav-link-text">Content</span></NavLink>
                    ...
                    <NavLink exact to='/developers' className='nav-link'><span className="nav-link-text">Discussion Forum</span></NavLink>
                </ReactBootStrap.Nav>
